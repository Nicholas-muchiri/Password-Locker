...
#         '''
#         self.new_user = Credentials(1,"Nick","subie")
...
#             self.assertEqual(self.new_user.user_name,"Nick")
#             self.assertEqual(self.new_user.password,"subie")
...
#         Setting up the structure before each test
#         '''
#         self.new_data = UsersData(1,1,"facebook.com","tututu")
...
#         self.assertEqual(self.new_data.web_key,"tututu")
...
#             '''
#             self.new_data.add_password()
#             test_data = UsersData(1,1,"facebook.com","tututu")
